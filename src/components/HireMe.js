                    ...
                    <div className="row justify-content-between">
                        <div className="col-md-8 col-lg-8 d-flex align-items-center">
                            <div className="w-100 py-4">
                                ...
                                <button className=" btn btn-color mb-0 mx-1"><a href="https://drive.google.com/file/d/1EsPQVKQ1BO4gc6dJsgqLkMbXfO7LskYK/view?usp=drive_link" target='_blank' className="btn" rel="noreferrer" style={{ color: '#b1b493' }}>Resume</a></button>
                            </div>
                        </div>
